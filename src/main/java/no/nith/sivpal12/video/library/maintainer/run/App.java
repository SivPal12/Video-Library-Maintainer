package no.nith.sivpal12.video.library.maintainer.run;
...
public class App {
    ...
    private static final String CONFIG_PACKAGE_LOCATION = "no.nith.sivpal12.video.library.maintainer.spring.config";
    ...
    private static void configLog4j() {
        ...
        RegexFilter filter = RegexFilter.createFilter("no.nith.sivpal12.video.library.maintainer", Boolean.TRUE.toString(), Result.ACCEPT.name(), Result.ACCEPT.name());
